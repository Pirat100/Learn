...
void Name::get_data() {
	...
	cout << "Введите отчество: "; cin >> this->otchestvo;
	cout << "Введите номер работника: "; cin >> this->id;
	writeData();
}
...
void Name::writeData() {
	ofstream outfile;
	outfile.open("C:\\Users\\Путь к файлу ... \\Desktop\\TEST.txt", ios::app | ios::out);
...
int countNames() {
	...
	ifstream infile;
	infile.open("C:\\Users\\Путь к файлу ... \\Desktop\\TEST.txt", ios::in);
