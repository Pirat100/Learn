...
#include "elev_app.h" // поставляется клиентом (застройщиком)
...
const int LOAD_TIME = 3; // время посадки/высадки в(в tick'ax)
...
private:
	...
	int unloading_timer; // ненулевое во время посадки

public:
	elevator(building*, int); // конструкторв
...
private:
	...
	int num_cars; // уже созданнные лифты, массив кнопок "вверх", "Вниз"
...
public:
	...
	void set_floor_req(const int, const int, const bool); // устанока запроса с этажа
